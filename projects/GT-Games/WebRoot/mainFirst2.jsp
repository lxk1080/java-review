	...
	<div class="container">
		...
		<div class="navigation">
			<ul class="navig cl-effect-3" >
				...
				<li><a href="ShowallnoteForuser?action=allMessage2&tsid=2">所有帖子</a></li>
...
<div class="banner-bot" style="background:#eee">
	<div class="container">
		...
		<div style="margin:20px 48px; text-align:left; float:left; cursor:pointer"><img style="width:280px; box-shadow:2px 2px 10px 2px black; height:155px; border-radius:0px;" src="images/g7.jpg"><br><br><span class="span">魔兽世界巫妖王之怒</span></div>
        
        <div style="margin:20px 48px; text-align:left; float:left; cursor:pointer"><img style="width:280px; box-shadow:2px 2px 10px 2px black; border-radius:0px;" src="images/g8.jpg"><br><br><span class="span">魔兽世界术士职业修炼路线</span></div>
        
        <div style="margin:20px 48px;; text-align:left; float:left; cursor:pointer"><img style="width:280px; box-shadow:2px 2px 10px 2px black; border-radius:0px;" src="images/g9.jpg"><br><br><span class="span">魔兽世界熊猫人之谜</span></div>

		<div style="margin:20px 48px; text-align:left; float:left; cursor:pointer"><img style="width:280px; box-shadow:2px 2px 10px 2px black; border-radius:0px;" src="images/g10.jpg"><br><br><span class="span">魔兽世界中立角色详解</span></div>

        <div style="margin:20px 48px; text-align:left; float:left; cursor:pointer"><img style="width:280px; box-shadow:2px 2px 10px 2px black; border-radius:0px;" src="images/g11.jpg"><br><br><span class="span">魔兽世界之军团在临</span></div>
        
        <div style="margin:20px 48px; text-align:left; float:left; cursor:pointer"><img style="width:280px; box-shadow:2px 2px 10px 2px black; border-radius:0px;" src="images/g12.jpg"><br><br><span class="span">魔兽世界之艾泽拉斯的净化</span></div>
		</div>
...
<div class="gallery" style=" background:#222">
	<div class="container">
		<h3 style="font-size:50px;">热门游戏</h3>
