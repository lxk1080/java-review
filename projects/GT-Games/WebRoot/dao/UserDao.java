...
public List<User> findBySname(User userParam,String sname){
	...
	public boolean add(User user) {
		String sql = "insert into user(sname,password,birthday,roleid,photo) values(?,?,?,?,?)";
		Object[] params = {user.getSname(),user.getPassword(),user.getBirthday(),user.getRoleid(),user.getPhoto()};
