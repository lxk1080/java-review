...
<div class="games" style="margin-top:-30px;">
	<div class="container">
        ...
        <div style="width:1140px;margin:0 auto"><img src="images/dao3.jpg" style="width:1140px; border:#666 solid 1px; " ></div>
        </div>
        <!--帖子列表-->
...
<div class="footer" style="margin-top:40px;">
	<div class="container">
		...
		<p>2017 Design by <a href="index.html">GT-Games</a></p>
	</div>
