		...
		<div class="page-content" style="background:url(img/bg00.jpg); background-position:;">
			...
			<form class="form-horizontal" action="user?action=list" method="post">
                           ...
                           <div class="input-group">
                               ...
                               <input type="text" class="form-control" name="sname" placeholder="输入你要搜索的用户名">
			...
			<table class="table table-bordered table-striped table-actions">
				<thead>
				<a href="ShowallnoteServlet?action=allnote" style="text-decoration:none; font-size:16px; display:inline-block; border:#666 solid 1px; border-radius:5px; width:120px; height:30px; line-height:30px; text-align:center; color:#000;">查询全部帖子</a></th>
					<tr>
				...
				<c:forEach items="${list}" var="user">
					<tr id="trow_1">
						<td><a href="user?action=view&id=${user.id}"><strong>${user.sname}</strong></a></td>
						<td>${user.rolename}</td>
						<td>
