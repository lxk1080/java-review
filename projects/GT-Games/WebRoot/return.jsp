...
.fh:hover{ border:#666 solid 1px;}
.ret{ color:#C60; position:relative; top:25px; cursor:pointer; font-size:14px;}
.ret:hover{ color:#c40}

<!--表格-->
div.dt{ width:2000px;}
table{ margin:0 auto;}
.tab tr th{ border:#333 solid 1px; border-radius:5px;}
.tab tr td{ background:#FAEDAF; height:100px; margin:5px; border-radius:5px; border:#CCC solid 1px;}
.tab tr{ margin-top:10px;}
.sub{ position:relative; top:-15px;}
.hf{ background:#333; color:#CCC; height:50px; line-height:50px; padding-left:20px; font-size:20px;}
</style>
...
<!--banner结束-->  
    <div class="hf">回复帖子</div>
    <!--回复开始-->
  <div class="content" style="margin-left:25px; margin-top:50px; border:res solid 1px;">
  ...
  <input type="submit" value="回复" class="sub" id="sub">
  </div>
</div>
