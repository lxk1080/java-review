  ...
  <div class="container">
    ...
    <div class="navigation">
      <ul class="navig cl-effect-3" >
        ...
        <li class="li"><a href="features.jsp">游戏menu</a>
          <ul class="alert">
            <div>魔兽世界</div>
            <div>地下城与勇士</div>
            <div>英雄联盟</div>
...
<div class="dt">
  <table class="tab" cellpadding="5" cellspacing="10" width="1300px">
  	<tr><th colspan="2" style="width:1300px; border:0; background:#333; color:#eee">本帖主题：说的分身乏术</th></tr>
    <tr>
      <th style="width:250px;">发帖人</th>
      <th style="width:1050px;">帖子内容</th>
    </tr>
    <tr>
      <td>${allnote.ttopic}</td>
